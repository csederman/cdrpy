...
def import_dualgcn_namespace() -> SimpleNamespace:
    ...
    from DualGCN import CalculateGraphFeat, CelllineGraphAdjNorm, MyCallback
...
def model_trainer(
    ...
    if params.hyper.early_stopping:
        callbacks.append(
            dualgcn.CustomCallback(
                val_data=val_dataset,
                result_file_path="./model",
                patience=20,
            )
        )
...
def run_pipeline(cfg: DictConfig) -> None:
    ...
    # train_dataset = train_dataset.sample(n=5000, name="train")
    # val_dataset = val_dataset.sample(n=1000, name="val")
    # test_dataset = test_dataset.sample(n=1000, name="test")
